import './news.css';
import { NewsInterface, Article } from '../../../../src/types/types';
...
class News implements NewsInterface {
    draw(data: Array<Article>): void {
        ...
        news.forEach((item: Article, idx: number): void => {
            ...
            (newsClone.querySelector('.news__meta-photo') as HTMLElement).style.backgroundImage = `url(${item.urlToImage || './asset/news_placeholder.jpg'
                })`;
